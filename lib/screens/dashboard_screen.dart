...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tasksAsyncValue = ref.watch(taskListStreamProvider(userRole == 'pegawai' ? userEmail : null));
    final projectsAsyncValue = ref.watch(projectListStreamProvider(userRole == 'pegawai' ? userEmail : null));
